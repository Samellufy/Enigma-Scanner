...
def members():
    ...
    try:
        ...
        if res.status_code != 200:
            response_data = {"not_200": "Link is not a valid link"}
...
# # # Sql report generation
    ...
    # # #---------------------------------Path Traversal------------------------------------------
        ...
        print(information_content_report)
        if len(information_content_report) > 0:
            check_information_disclouser.information_disclouser_draw_pie()
            response_data["information_disclouser"] = information_content_report
            rgeneration.generate_report("information_disclouser",information_content_report,"information.pdf","Practice/reports/report_text/information_disclouser.txt","Practice/reports/mitigations/information_disclouser_mitigation.txt")
        ...
        if directory_traversal_content_report:
            ...
            rgeneration.generate_report("path_traversal",directory_traversal_content_report,"path_traversal.pdf","Practice/reports/report_text/path_traversal.txt","Practice/reports/mitigations/path_traversal_mitigations.txt")
...
def non_sub():
    ...
    try:
        ...
        # Check for information disclosure
        print("checking for informatioin disclouser")
        check_information_disclouser = InformationDisclouser(target_url, crawl_links)
        check_information_disclouser.check_for_robotstxt_file()
        information_content_report = check_information_disclouser.get_security_report_content()
        # Check for security headers
